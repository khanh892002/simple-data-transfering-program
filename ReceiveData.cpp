...
int main(int argc, char *argv[]) {
	...
	serv_addr.sin_port = htons(portno); // convert short integer value for port must be converted into network byte order
	...
	send(newsockfd, "Hello, world!\n", 13, 0);// hàm send gửi chuỗi 13B vào socket mới
